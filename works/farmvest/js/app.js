(() => {
    ...
    (() => {
        ...
        const partnersRoot = document.querySelector(".partners__body");
        const partnersUnit = getComputedStyle(partnersRoot).getPropertyValue("--partners-units");
        const partnersTrack = document.querySelector(".partners__track"), itemWidth = partnersTrack.querySelectorAll(".partners__item");
        let itemsWidth = 0;
        itemWidth.forEach((element => {
            let item = element.offsetWidth;
            return itemsWidth += item;
        }));
        partnersRoot.style.setProperty("--partners-track", itemsWidth + "px");
        partnersRoot.style.setProperty("--partners-units-js", partnersTrack.children.length);
        for (let i = 0; i < partnersUnit; i++) partnersTrack.appendChild(partnersTrack.children[i].cloneNode(true));
